...
void StateConfig::Configure(StateMachine& state_machine, Application* app) {
    ...
    state_machine.RegisterState(static_cast<int>(AppState::vision_detected), 
        [app]() { SpeakingState::Enter(app); }, 
        [app]() { SpeakingState::Exit(app); });
    ...
    state_machine.RegisterTransition(static_cast<int>(AppState::idle), static_cast<int>(AppEvent::vision_detected), static_cast<int>(AppState::thinking));
    ...
    state_machine.RegisterTransition(static_cast<int>(AppState::thinking), static_cast<int>(AppEvent::dialogue_end), static_cast<int>(AppState::idle));
